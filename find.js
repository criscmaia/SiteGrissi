...
var window_border = "#DD0000"; // the border color of pop-up window
var text_color = "#008000"; // the color of the text in window
...
function findit() 
{
	...
	if (string)  // only call findText if there is a string or IE will have error
		...
		else
		{
		    ...
		    {     
		         test.innerHTML = "N&atilde;o encontrado";
...
document.write('<div id="findwindow" style="position:absolute'
	...
	+ ';padding: 0px'
	+ ';font-size: 12px'
  + ';-moz-border-radius: 10px'     // coloca 
  + ';-webkit-border-radius: 10px'  // a borda
...
document.write('<div id="window_body" style="padding: 5px;">'
	...
	+ '<input id="btn" type="button" value="Pr&oacute;ximo" onclick="findit();">'
	+ '</div>\n'
	+ '<div id="test"><br /></div>');
document.write('</div>');
...
document.write('<input type="button" value="Clique para pesquisar!"'
	+ ' onclick="show();">');
