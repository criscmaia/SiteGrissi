...
<?php render("header", ["title" => "Lembranças"]); ?>
...
<div class="box">
    <div class="esquerda">
        <div class="chat-bubble">
            ...
            <?php
                $filename = ("images/lembrancas/LauritaGrissiBertolin.jpg");
                if (file_exists($filename)) {
                    echo '<img src="'.$filename.'" alt="Laurita Grissi Bertolin"/>';
                } else {
    ...
    <blockquote class="direita">
        <p>Jo&atilde;o Gris e Josephina Gris Toffolo, emigraram para o Brasil viajando 30 dias a bordo de um navio, desembarcando no Rio Grande do Sul, onde permaneceram alguns meses indo, mais tarde, para S&atilde;o Jo&atilde;o Del Rey, come&ccedil;ando l&aacute; uma agricultura de subsist&ecirc;ncia. Alguns anos depois vieram para a Col&ocirc;nia Rodrigo Silva, pr&oacute;ximo &agrave; Barbacena, onde permaneceram a maior parte de suas vidas. Seus filhos: Germano, Vit&oacute;rio, Olivio, Jos&eacute;, Ernesto, Rodolpho, Luiza, Vitalina e Laurita Grissi.</p><br>
        <p>Foram para o Rio Grande do Sul onde ficaram tr&ecirc;s meses, estranharam muito o clima nesta terra muito estranha para eles e a m&atilde;e Luigia morreu de parto l&aacute;. Foram para S&atilde;o Jo&atilde;o Del Rey onde ficaram tr&ecirc;s anos e ganharam terras para ensinar os brasileiros a trabalhar nas lavouras. O av&ocirc; Luigi morreu em S&atilde;o Jo&atilde;o Del Rey. Meus av&oacute;s falavam que na It&aacute;lia ele trabalhava para uma fam&iacute;lia muito rica e minha av&oacute; n&atilde;o queria que ele viesse para o Brasil, tendo chorado tr&ecirc;s dias para n&atilde;o vir. Ele achava que aqui no Brasil as condi&ccedil;&otilde;es de vida eram melhores, mas passaram muita fome. Meu pai e os outros filhos foram criados praticamente sem pai e m&atilde;e. N&atilde;o tiveram estudo e s&oacute; com a orienta&ccedil;&atilde;o dos outros e como eram muito inteligentes faziam v&aacute;rios servi&ccedil;os como carpinteiro, bombeiro, construtor. Em Curvelo tem uma ponte constru&iacute;da por ele. O pavilh&atilde;o de Dr. S&aacute; Fortes tamb&eacute;m foi constru&iacute;do por ele, assim como um trecho de Barbacena at&eacute; a ponte de Caieiras.</p><br>
        <p>No Brasil tiveram que fazer novo registro, sen&atilde;o n&atilde;o poderiam ficar. Meu pai e as irm&atilde;s foram criados por Tunina Roman. Giovanni era um santo, gostava muito de cria&ccedil;&atilde;o, conversava com os cavalos e n&atilde;o matava nenhuma cobra, n&atilde;o sendo mordido nunca. Carregava-as nas costas junto com o feixe de capim. Os filhos pediam para matar e ele dizia: de jeito nenhum, ela tem que viver. Tratava os animais com muito carinho e rezava muito.</p><br>
        <p>Meu pai era um homem muito vaidoso e andava sempre bem vestido, e quando trabalhava, mantinha a roupa sempre limpa.</p><br>
        <p>Lembro-me da Fiorina, (irm&atilde; de Luigi ou Luigia) que veio junto com eles, mas n&atilde;o quis ficar na Col&ocirc;nia e voltou para o Rio Grande do Sul onde faleceu.</p><br>
        <p>A minha primeira irm&atilde; Ang&eacute;lica, que faleceu e teve o nascimento de uma irm&atilde;, a Carmen que faleceu com um ano e seis meses, de febre tif&oacute;ide.</p><br>
...
<div class="box">
    <div class="esquerda">
        <div class="chat-bubble">
            ...
            <div class="chat-bubble-arrow"></div>
            <?php
                $filename = ("images/lembrancas/AndreaBergaminiReis.jpg");
                if (file_exists($filename)) {
                    echo '<img src="'.$filename.'" alt="Andr&eacute;a Bergamini Reis"/>';
                } else {
                    echo '<img src="images/nophoto.jpg" alt="Sem foto"/>';
                }
            ?>
    ...
    <div class="direita">
        <p>&Eacute; com grande entusiasmo que recebemos sua carta e parabenizo-a pela maravilhosa atitude.</p><br>
...
<div class="box">
    <div class="esquerda">
        <div class="chat-bubble">
            ...
            <div class="chat-bubble-arrow"></div>
            <?php
                $filename = ("images/lembrancas/JoseFernandesGrissi.jpg");
                if (file_exists($filename)) {
                    echo '<img src="'.$filename.'" alt="Jos&eacute; Fernandes Grissi"/>';
                } else {
                    echo '<img src="images/nophoto.jpg" alt="Sem foto"/>';
                }
            ?>
...
<div class="box">
    <div class="esquerda">
        <div class="chat-bubble">
            ...
            <div class="chat-bubble-arrow"></div>
            <?php
                $filename = ("images/lembrancas/DauraGrissiCandian.jpg");
                if (file_exists($filename)) {
                    echo '<img src="'.$filename.'" alt="Daura Grissi Candian Apelido: Cabrita"/>';
                } else {
                    echo '<img src="images/nophoto.jpg" alt="Sem foto"/>';
                }
            ?>
    ...
    <div class="direita">
        <p>Se eu fosse dizer tudo sobre o passado e o presente, iria levar muito tempo e papel. O meu passado foi cheio de coisas boas e tristes ao mesmo tempo, pergunte &agrave; sua m&atilde;e, pois passamos v&aacute;rias f&eacute;rias juntas aqui e era muito divertido.</p><br>
...
<div class="box">
    <div class="esquerda">
        <div class="chat-bubble">
            ...
            <div class="chat-bubble-arrow"></div>
            <?php
                $filename = ("images/lembrancas/MariaLuizaGrissiBergamini.jpg");
                if (file_exists($filename)) {
                    echo '<img src="'.$filename.'" alt="Maria Luiza Grissi Bergamini"/>';
                } else {
                    echo '<img src="images/nophoto.jpg" alt="Sem foto"/>';
                }
            ?>
    ...
    <div class="direita">
        <p>Maria Luiza, chamada de Luizinha por seu pai e irm&atilde;os, trabalhava na ro&ccedil;a junto com todos, capinando milho, feij&atilde;o e eram confundidos com os empregados, por trabalharem como igual, usando roupas adequadas ao sol. As irm&atilde;s sempre foram muito branquinhas, usavam roupas compridas e chap&eacute;u.</p><br>
        <p>Luiza e An&eacute;sia iam buscar os bezerros no pasto, ao som do acordeon do Jo&atilde;ozinho, cuja musica preferida era Asa Branca. &Agrave; noite se reuniam para terminar os afazeres dom&eacute;sticos, bem como os bordados. Ao dormir, Luiza sempre rezava o Pai Nosso e Ave Maria ajoelhada ao p&eacute; da cama, as ora&ccedil;&otilde;es tradicionais ensinadas por seus pais. Antes de irem dormir, ficavam em volta da cama de seu pai Jos&eacute; que cantava uma musica italiana que aprendera com sua m&atilde;e Josephina, cuja letra era:</p><br>
        <p align="center">
            <b>S&aacute;bato de Cera (S&aacute;bado de tarde)</b>
            <br>
            <br>Que thentho passava
            <br>La dedi chamava
            <br>Que thentho vem su
            <br>Levantas cadeira
            <br>Que didia lo prega
            <br>Fa na dormir
            <br><br>
        </p>
...
<div class="box">
    <div class="esquerda">
        <div class="chat-bubble">
            ...
            <div class="chat-bubble-arrow"></div>
            <?php
                $filename = ("images/lembrancas/MadalenaGrissi.jpg");
                if (file_exists($filename)) {
                    echo '<img src="'.$filename.'" alt="Madalena Grissi"/>';
                } else {
                    echo '<img src="images/nophoto.jpg" alt="Sem foto"/>';
                }
            ?>
    ...
    <div class="direita">
        <p>Meus av&oacute;s, Josephina e Jo&atilde;o nasceram na It&aacute;lia. Tiveram nove filhos, os quais nasceram no Brasil. Contava meu pai, Jos&eacute; Grissi, que o vov&ocirc; era um homem en&eacute;rgico e met&oacute;dico. Personalidades fortes, caracter&iacute;stica que o meu pai Jos&eacute; herdou. Falavam o idioma italiano e pouco o portugu&ecirc;s. Ensinaram o italiano para os filhos e alguns netos.</p><br>
...
<div class="box">
    <div class="esquerda">
        <div class="chat-bubble">
            ...
            <div class="chat-bubble-arrow"></div>
            <?php
                $filename = ("images/lembrancas/DulceGrissiZonzin.jpg");
                if (file_exists($filename)) {
                    echo '<img src="'.$filename.'" alt="Dulce Grissi Zonzin"/>';
                } else {
                    echo '<img src="images/nophoto.jpg" alt="Sem foto"/>';
                }
            ?>
    ...
    <div class="direita">
        <b>Receita de fam&iacute;lia para curar bronquite:</b>
        <br> 9 folhas de hortel&atilde;
        <br> 9 folhas de cidreira
        <br> 9 cravos da &Iacute;ndia
        <br> 3 galhos de alecrim
        <br> 3 cascas de canela
        <br> 9 cebolinhas brancas
        <br> 2 x&iacute;caras de ch&aacute; de a&ccedil;&uacute;car
        <br> 1 x&iacute;cara de ch&aacute; de mel
        <br> 6 gotas de iodo
        <br><br>
...
<div class="box">
    <div class="esquerda">
        <div class="chat-bubble">
            ...
            <div class="chat-bubble-arrow"></div>
            <?php
                $filename = ("images/lembrancas/MariadeFatimaGrissi.jpg");
                if (file_exists($filename)) {
                    echo '<img src="'.$filename.'" alt="Maria de F&aacute;tima Grissi"/>';
                } else {
                    echo '<img src="images/nophoto.jpg" alt="Sem foto"/>';
                }
            ?>
...
<div class="box">
    <div class="esquerda">
        <div class="chat-bubble">
            ...
            <div class="chat-bubble-arrow"></div>
            <?php
                $filename = ("images/lembrancas/MauroGris.jpg");
                if (file_exists($filename)) {
                    echo '<img src="'.$filename.'" alt="Mauro Gris"/>';
                } else {
                    echo '<img src="images/nophoto.jpg" alt="Sem foto"/>';
                }
            ?>
...
<div class="box">
    <div class="esquerda">
        <div class="chat-bubble">
            ...
            <div class="chat-bubble-arrow"></div>
            <?php
                $filename = ("images/lembrancas/MariadasGracasGrisDrumond.jpg");
                if (file_exists($filename)) {
                    echo '<img src="'.$filename.'" alt="Maria das Graças Gris Drumond"/>';
                } else {
                    echo '<img src="images/nophoto.jpg" alt="Sem foto"/>';
                }
            ?>
...
<div class="box">
    <div class="esquerda">
        <div class="chat-bubble">
            ...
            <div class="chat-bubble-arrow"></div>
            <?php
                $filename = ("images/lembrancas/MaraGrisPetinelli.jpg");
                if (file_exists($filename)) {
                    echo '<img src="'.$filename.'" alt="Mara Gris Petinelli"/>';
                } else {
                    echo '<img src="images/nophoto.jpg" alt="Sem foto"/>';
                }
            ?>
...
<div class="box">
    <div class="esquerda">
        <div class="chat-bubble">
            ...
            <div class="chat-bubble-arrow"></div>
            <?php
                $filename = ("images/lembrancas/MariadaConceicaoGris.jpg");
                if (file_exists($filename)) {
                    echo '<img src="'.$filename.'" alt="Maria da Conceição Gris"/>';
                } else {
                    echo '<img src="images/nophoto.jpg" alt="Sem foto"/>';
                }
            ?>
...
<div class="box">
    <div class="esquerda">
        <div class="chat-bubble">
            ...
            <div class="chat-bubble-arrow"></div>
            <?php
                $filename = ("images/lembrancas/DalvaGrissi.jpg");
                if (file_exists($filename)) {
                    echo '<img src="'.$filename.'" alt="Dalva Grissi"/>';
                } else {
                    echo '<img src="images/nophoto.jpg" alt="Sem foto"/>';
                }
            ?>
    ...
    <div class="direita">
        <p>Lembro-me das idas na casa das tias, com a V&oacute; Pina e eu era sua guarda-costas. Lembro-me da idade de 6 anos quando ia para a escola na companhia da Daura e Jo&atilde;ozinho. Eles passavam pela tia L&uacute;cia para irem com a Helena para a aula, mas &agrave;s vezes n&atilde;o iam &agrave; escola era nada, ficavam catando veludinho, uma fruta silvestre, perto do Zezinho Pissolatti. Quando tia L&uacute;cia descobria era aquela bronca, contava a meu pai e o pau comia.</p><br>
        <p>Lembro-me das brincadeiras de casinha com Ad&eacute;lia, Daura, Helena. Ad&eacute;lia tinha uma siriema filhote e todo o dia dava angu para trat&aacute;-la, eu queria peg&aacute;-la e ajudar, mas Ad&eacute;lia n&atilde;o deixava e eu abria a boca a chorar. Era aquela confus&atilde;o. T&iacute;nhamos eu e Dulce, uma casinha de lata velha. De vez em quando, o Jo&atilde;ozinho que era o nosso compadre brigava e derrubava tudo. Era aquele tem-de-p&aacute;. Meus pais falavam que parec&iacute;amos ciganos e cada hora arm&aacute;vamos a casa em um local. Lembro-me das hist&oacute;rias que meu pai contava, com os filhos todos encarrapitados em cima da cama. Isto acontecia ao anoitecer, enquanto D. Em&iacute;lia arrumava a cozinha do jantar. Lembro-me das rezas na Igreja de S&aacute; Fortes, aquele frio de lascar e na volta entr&aacute;vamos debaixo da capa do pai, aquelas capas antigas, parecendo um galo e os pintinhos. Lembro-me dos tempos que o Rodolphinho passava f&eacute;rias l&aacute; em casa e ia para a horta trabalhar comigo e a Dulce e nos ensinava a cantar (Forrobod&oacute;, o galo carij&oacute;), era uma festa e aprendemos tantas piadas com ele. Lembro-me dos parentes que passavam as f&eacute;rias l&aacute; em casa. Tia Zulmira com a fam&iacute;lia, tia Suzana, primos, passavam 15 dias, ensinava a gente a bordar, &iacute;amos passear na tia L&uacute;cia. Era uma festa. Lembro-me das surras depois das nossas peraltices de crian&ccedil;as, dos gring&otilde;es do S&ecirc;o Jos&eacute; Grissi depois do m&eacute;.</p><br>
        <p>Com Vov&oacute; Pina aprendi a rezar o Pater Noster e com meu pai aprendi a cantar S&aacute;bado de S&ecirc;ra. Esta modinha &eacute; italiana e nosso pai nos ensinava. Meus av&oacute;s eram natos da It&aacute;lia, por parte de pai. Por parte de m&atilde;e eram mesti&ccedil;os, av&oacute;s Piva (italiano) -maternos- &iacute;ndios, portanto sou neta de &iacute;ndio e italianos.</p><br>
        <p><b>Supersti&ccedil;&otilde;es:</b>
            <br>Diziam que na quaresma n&atilde;o podia dan&ccedil;ar porque lobisomem apareceria.
            <br>Benzer de quebranto e ventre virados era constante.
            <br>N&atilde;o mexer com fogo porque se fazia xixi na cama.
            <br><br>
...
<div class="box">
    <div class="esquerda">
        <div class="chat-bubble">
            ...
            <div class="chat-bubble-arrow"></div>
            <?php
                $filename = ("images/lembrancas/ZairaMoreiraGrissi.jpg");
                if (file_exists($filename)) {
                    echo '<img src="'.$filename.'" alt="Zaira Moreira Grissi"/>';
                } else {
                    echo '<img src="images/nophoto.jpg" alt="Sem foto"/>';
                }
            ?>
...
<div class="box">
    <div class="esquerda">
        <div class="chat-bubble">
            ...
            <div class="chat-bubble-arrow"></div>
            <?php
                $filename = ("images/lembrancas/RitadeCassiaBorgo.jpg");
                if (file_exists($filename)) {
                    echo '<img src="'.$filename.'" alt="Rita de Cássia Borgo"/>';
                } else {
                    echo '<img src="images/nophoto.jpg" alt="Sem foto"/>';
                }
            ?>
    ...
    <div class="direita">
        <p>O pai de Josephina veio de Malta Migracion. Ana morreu na viagem para o Brasil. Dizem que nossos av&oacute;s paternos tinham o sobrenome MORAES e na vinda para o Brasil a fam&iacute;lia de minha bisav&oacute; materna lhes deu o sobrenome GRISSI. Irm&atilde;os de Josephina - Jos&eacute;, Ant&ocirc;nio, Olivio Tofoli. Irm&atilde;os de Giovanni - Rosa Grissi Candian, Maria Grissi e Ant&ocirc;nio. Um dos irm&atilde;os de Giovanni (Ant&ocirc;nio) era o av&ocirc; de L&uacute;cia Picinin Grissi. Eis a semelhan&ccedil;a de L&uacute;cia e as cunhadas, Luiza, Italina, Jos&eacute;, Laurita, etc. Jo&atilde;o Vicente Tofoli teria arrependido de ter vindo, pois fora enganado, que aqui no Brasil as coisas eram f&aacute;ceis. Na It&aacute;lia ele trabalhava com algu&eacute;m muito rico. Rosa e Maria vieram adolescentes. Maria se casou e sofreu muito. Foi cuidada na casa de Josephina. Quando chegaram permaneceram pouco no Rio Grande do Sul e o pai de Giovanni morreu. Em seguida vieram para S&atilde;o Jo&atilde;o Del Rei onde Giovanni aprendeu a ler com algumas pessoas. Gostava de jornal e em momentos de ins&ocirc;nia tamb&eacute;m os lia. Giovanni foi empregado do DER, plantou muitas frutas, fazia vinho, trabalhava de carpinteiro. O sogro de Giovanni, Vicente Toffoli n&atilde;o permitia matar os bichos, conversava com eles e contam que quando ele ia fazer a cama para as vacas, talvez no meio do capim iam algumas cobras e ele n&atilde;o as matava. Jo&atilde;o sabia apenas escrever seu nome, mas era muito inteligente, bondoso, humilde e paciente. Josephina tinha um apelido: Nona Pina. Muito sens&iacute;vel, chorava demais. Gostava de fazer sopa (cozido). Misturava todos os legumes inteiros com caldo de lingui&ccedil;a de porco (muzet). Cantava em italiano o Pai Nosso, Ave Maria e Salve Rainha.</p><br>
    </div>
</div>
...
<div class="box">
    <div class="esquerda">
        <div class="chat-bubble">
            ...
            <div class="chat-bubble-arrow"></div>
            <?php
                $filename = ("images/lembrancas/AdeliaGrissiBorgo.jpg");
                if (file_exists($filename)) {
                    echo '<img src="'.$filename.'" alt="Adélia Grissi Borgo"/>';
                } else {
                    echo '<img src="images/nophoto.jpg" alt="Sem foto"/>';
                }
            ?>
...
<div class="box">
    <div class="esquerda">
        <div class="chat-bubble">
            ...
            <div class="chat-bubble-arrow"></div>
            <?php
                $filename = ("images/lembrancas/AngelaMariaGrissiMachado.jpg");
                if (file_exists($filename)) {
                    echo '<img src="'.$filename.'" alt="Angela Maria Grissi Machado"/>';
                } else {
                    echo '<img src="images/nophoto.jpg" alt="Sem foto"/>';
                }
            ?>
    ...
    <div class="direita">
        <p>Aponto as seguintes d&uacute;vidas quanto ao nome e a origem da fam&iacute;lia Grissi. A grafia correta do nome pode ter as seguintes varia&ccedil;&otilde;es: GRISSI - GRIS E GRISI.
            <p/><br>
...
<div class="box">
    <div class="esquerda">
        <div class="chat-bubble">
            ...
            <div class="chat-bubble-arrow"></div>
            <?php
                $filename = ("images/lembrancas/NormaCanton.jpg");
                if (file_exists($filename)) {
                    echo '<img src="'.$filename.'" alt="Norma Canton"/>';
                } else {
                    echo '<img src="images/nophoto.jpg" alt="Sem foto"/>';
                }
            ?>
...
<div class="box">
    <div class="esquerda">
        <div class="chat-bubble">
            ...
            <div class="chat-bubble-arrow"></div>
            <?php
                $filename = ("images/lembrancas/BeatrizCanton.jpg");
                if (file_exists($filename)) {
                    echo '<img src="'.$filename.'" alt="Beatriz Canton"/>';
                } else {
                    echo '<img src="images/nophoto.jpg" alt="Sem foto"/>';
                }
            ?>
...
<div class="box">
    <div class="esquerda">
        <div class="chat-bubble">
            ...
            <div class="chat-bubble-arrow"></div>
            <?php
                $filename = ("images/lembrancas/GeraldoCanton.jpg");
                if (file_exists($filename)) {
                    echo '<img src="'.$filename.'" alt="Geraldo Canton"/>';
                } else {
                    echo '<img src="images/nophoto.jpg" alt="Sem foto"/>';
                }
            ?>
...
<div class="box">
    <div class="esquerda">
        <div class="chat-bubble">
            ...
            <div class="chat-bubble-arrow"></div>
            <?php
                $filename = ("images/lembrancas/JosephinaLiporatti.jpg");
                if (file_exists($filename)) {
                    echo '<img src="'.$filename.'" alt="Josephina Liporatti"/>';
                } else {
                    echo '<img src="images/nophoto.jpg" alt="Sem foto"/>';
                }
            ?>
...
<div class="box">
    <div class="esquerda">
        <div class="chat-bubble">
            ...
            <div class="chat-bubble-arrow"></div>
            <?php
                $filename = ("images/lembrancas/RodolphoCanton.jpg");
                if (file_exists($filename)) {
                    echo '<img src="'.$filename.'" alt="Rodolpho Canton"/>';
                } else {
                    echo '<img src="images/nophoto.jpg" alt="Sem foto"/>';
                }
            ?>
...
<div class="box">
    <div class="esquerda">
        <div class="chat-bubble">
            ...
            <div class="chat-bubble-arrow"></div>
            <?php
                $filename = ("images/lembrancas/TherezaCanton.jpg");
                if (file_exists($filename)) {
                    echo '<img src="'.$filename.'" alt="Thereza Canton"/>';
                } else {
                    echo '<img src="images/nophoto.jpg" alt="Sem foto"/>';
                }
            ?>
...
<div class="box">
    <div class="esquerda">
        <div class="chat-bubble">
            ...
            <div class="chat-bubble-arrow"></div>
            <?php
                $filename = ("images/lembrancas/LauritaCanton.jpg");
                if (file_exists($filename)) {
                    echo '<img src="'.$filename.'" alt="Laurita Canton"/>';
                } else {
                    echo '<img src="images/nophoto.jpg" alt="Sem foto"/>';
                }
            ?>
...
<div class="box">
    <div class="esquerda">
        <div class="chat-bubble">
            ...
            <div class="chat-bubble-arrow"></div>
            <?php
                $filename = ("images/lembrancas/MariaAdesiaCantondeCastro.jpg");
                if (file_exists($filename)) {
                    echo '<img src="'.$filename.'" alt="Maria Adésia Canton de Castro"/>';
                } else {
                    echo '<img src="images/nophoto.jpg" alt="Sem foto"/>';
                }
            ?>
...
<div class="box">
    <div class="esquerda">
        <div class="chat-bubble">
            ...
            <div class="chat-bubble-arrow"></div>
            <?php
                $filename = ("images/lembrancas/JaquelineGrissiCardoso.jpg");
                if (file_exists($filename)) {
                    echo '<img src="'.$filename.'" alt="Jaqueline Grissi Cardoso"/>';
                } else {
                    echo '<img src="images/nophoto.jpg" alt="Sem foto"/>';
                }
            ?>
...
<div class="box">
    <div class="esquerda">
        <div class="chat-bubble">
            ...
            <div class="chat-bubble-arrow"></div>
            <?php
                $filename = ("images/lembrancas/AlexandreGrissiMabillot.jpg");
                if (file_exists($filename)) {
                    echo '<img src="'.$filename.'" alt="Alexandre Grissi Mabillot"/>';
                } else {
                    echo '<img src="images/nophoto.jpg" alt="Sem foto"/>';
                }
            ?>
...
<div class="box">
    <div class="esquerda">
        <div class="chat-bubble">
            ...
            <div class="chat-bubble-arrow"></div>
            <?php
                $filename = ("images/lembrancas/AdrianaGrissiMabillot.jpg");
                if (file_exists($filename)) {
                    echo '<img src="'.$filename.'" alt="Adriana Grissi Mabillot"/>';
                } else {
                    echo '<img src="images/nophoto.jpg" alt="Sem foto"/>';
                }
            ?>
...
<div class="box">
    <div class="esquerda">
        <div class="chat-bubble">
            ...
            <div class="chat-bubble-arrow"></div>
            <?php
                $filename = ("images/lembrancas/VeraLuciaCantoneGilbertoPedrosaGuimaraes.jpg");
                if (file_exists($filename)) {
                    echo '<img src="'.$filename.'" alt="Vera Lucia Canton e Gilberto Pedrosa Guimarães"/>';
                } else {
                    echo '<img src="images/nophoto.jpg" alt="Sem foto"/>';
                }
            ?>
...
<div class="box">
    <div class="esquerda">
        <div class="chat-bubble">
            ...
            <div class="chat-bubble-arrow"></div>
            <?php
                $filename = ("images/lembrancas/ComissaoOrganizadora.jpg");
                if (file_exists($filename)) {
                    echo '<img src="'.$filename.'" alt="Comissão Organizadora"/>';
                } else {
                    echo '<img src="images/nophoto.jpg" alt="Sem foto"/>';
                }
            ?>
    ...
    <div class="direita">
        <p>No livro <b>"100 anos da Ind&uacute;stria  em Belo Horizonte" - FIEMG/SESI - 1998</b>, encontrei o registro do seguinte diploma:</p><br>
        <p>A comiss&atilde;o organizadora da Feira Industrial Agr&iacute;cola de Belo Horizonte, realizada em julho/ agosto de 1932, de conformidade ao art.22 do Regulamento, aprovado pela Prefeitura Municipal e de acordo com a decis&atilde;o do J&uacute;ri, concede &agrave; firma
            <p>
                <p align="center">
                    <br><b>GRISSI E TOFFOLO</b>
                    <br> Medalha de Ouro
                    <br>Aos produtos: Balas, Caramelos,Bombons,etc
